<style>
    ...
    *::after {
    ...
    #hasil-kab-atas, .titik-atas {
        color: #1893A8;
        font-weight: bold;
    }

    #hasil-kab-bawah, .titik-bawah{
        color: #1893A8;
        font-weight: bold;
    }
    ...
    <section id="" class="section pb-5 mb-5">
        <div class="container" style="background: #eceeef6e; border-radius: 14px;">
            <div class="section-header pt-3 mt-3" style="padding-bottom: 23px;">
                <h3 data-aos="fade-down pt-3 mt-3">Kalkulator Harga Kabinet Kitchen Set</h3>
                <form class="forms-sample pt-3">
                    <div class="form-group row">
                        <label for="kab-atas" class="col-sm-3 col-form-label">Kabinet Atas</label>
                        <div class="col-sm-4">
                            <input type="number" class="form-control" id="kab-atas" placeholder=""><i class="satuan"> Cm</i>
                        </div>
                    </div>
                    <div class="form-group row mt-2 pt-2 kab-bawah">
                        <label for="kab-bawah" class="col-sm-3 col-form-label text-left">Kabinet Bawah</label>
                        <div class="col-sm-4">
                            <input type="number" class="form-control" id="kab-bawah" placeholder=""><i class="satuan"> Cm</i>
                        </div>
                    </div>
                    <center class="mt-4 mb-4 tom-hit" data-aos="fade-right">
                        <p><a class="btn-cta1 mr-2" href="#">Hitung Estimasi </a></p>
                    </center>
                    ...
                    <div class="ket-harga">
                        <h5 class="mt-3 pt-3">Keterangan Harga</h5>
                        <div class="flex-container">
                            <h6 class="mt-1 pt-1" id="hasil-kab-atas">Harga Kabinet Atas :</h6>
                        </div>
                        <div class="flex-container">
                            <h6 class="mt-1 pt-1" id="hasil-kab-bawah">Harga Kabinet Bawah :</h6>
                        </div>
                    </div>
                </form>
            </div>
